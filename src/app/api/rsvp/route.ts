...
export async function POST(request: Request) {
  try {
    ...
    const GOOGLE_FORM_URL = process.env.GOOGLE_FORM_URL || "https://docs.google.com/forms/d/e/1FAIpQLSdeEskyww36Ue5miH26hgqEQagEZks8JH51T3SJvtXWI0Lbdw/formResponse";
